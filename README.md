...
- SecureCRT의 `Keyword List V2`와 `Keyword List V3` 형식을 제공합니다. 두 목록은 같은 325개 규칙을 사용합니다.
...
- `PNET-Cisco-Dark-V3.ini`: 같은 325개 규칙을 SecureCRT `Keyword List V3` 형식으로 저장한 키워드 하이라이트 목록
