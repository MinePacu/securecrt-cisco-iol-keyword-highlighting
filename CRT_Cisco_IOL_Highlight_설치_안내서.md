...
<!-- 사진 1: 다운로드한 ZIP 파일을 마우스 오른쪽 버튼으로 클릭해 ‘압축 풀기/Extract All’을 선택하는 화면을 넣으세요. 안내 문구는 실제 사진으로 교체하세요. -->
![사진 1 — ZIP에서 압축 풀기/Extract All을 선택하는 화면](./images/사진-01-압축풀기.png)

ZIP 전체를 압축 해제한 뒤 새 폴더를 엽니다.

<!-- 사진 2: 압축 해제 폴더 안에서 Install-KeywordHighlight-Setup.exe를 찾은 화면을 넣으세요. 안내 문구는 실제 사진으로 교체하세요. -->
![사진 2 — 압축 해제 폴더에서 설치 실행 파일을 찾은 화면](./images/사진-02-설치파일찾기.png)
...
실제 배포본에서 색상 하이라이트가 보이는 최종 결과 사진을 넣습니다. 사진 1~6의 안내 주석과 설명을 확인한 뒤 실제 스크린샷으로 교체해 배포하세요.
